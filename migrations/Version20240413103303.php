 ...
 */
final class Version20240413103303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, patronymic VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_BDAFD8C8A9D1C132C808BA5AE42A05AB (first_name, last_name, patronymic), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, year VARCHAR(4) NOT NULL, isbn VARCHAR(17) NOT NULL, UNIQUE INDEX UNIQ_CBE5A3312B36786BCC1CF4E6 (title, isbn), UNIQUE INDEX UNIQ_CBE5A3312B36786BBB827337 (title, year), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
